...
export default function Messages() {
  ...
  // Count only messages that are truly unread (read_at is null or undefined)
  const unreadCount = visibleInbox.filter(m => m.read_at === null || m.read_at === undefined).length;
    ...
    <div className="w-full min-h-screen bg-white">
      ...
      <div className="max-w-7xl mx-auto px-4 -mt-12 pb-16">
        <div className="bg-white rounded-3xl shadow-2xl border border-gray-200 overflow-hidden backdrop-blur-sm">
          ...
          {/* TABS BAR */}
          <div className="bg-gradient-to-br from-white to-gray-50 p-6 border-b border-gray-200">
            <div className="flex flex-col lg:flex-row justify-between items-stretch lg:items-center gap-4">
              ...
              <div className="flex flex-wrap gap-3">
                <button
                  ...
                  className={`group relative px-5 py-3.5 rounded-xl font-bold text-sm transition-all duration-300 flex items-center gap-2 min-w-[160px]
                    ${activeTab === 'inbox'
                      ? 'bg-gradient-to-r from-[#294a70] to-[#324D6B] text-white shadow-xl scale-105'
                ...
                <button
                  ...
                  className={`group px-5 py-3.5 rounded-xl font-bold text-sm transition-all duration-300 flex items-center gap-2 min-w-[160px]
                    ${activeTab === 'sent'
                      ? 'bg-gradient-to-r from-[#294a70] to-[#324D6B] text-white shadow-xl scale-105'
                      : 'bg-white text-gray-700 hover:bg-gray-100 hover:shadow-md border-2 border-gray-200 hover:border-[#294a70]'
                  }`}
              ...
              {activeTab !== 'compose' && (
                <button
                  ...
                  className="group relative bg-gradient-to-r from-[#ffab1f] to-[#ff9500] hover:from-[#ff9500] hover:to-[#ffab1f]
          ...
          <div className="p-6 md:p-10 min-h-[600px]">
            ...
            <div className="mb-8">
              ...
              <div className="mt-3 h-1 w-24 bg-gradient-to-r from-[#ffab1f] to-[#ff9500] rounded-full"></div>
            </div>
